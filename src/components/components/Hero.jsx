  ...
  return (
    <section className='relative w-full h-screen mx-auto'>
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi , I am <span className='text-[#915eff]'>Abhijeet</span></h1>
          <p className={`${styles.heroSubText} text-white-100`}> I'm Fullstack Developer , I Develop user interfaces and web Applications</p>
        </div>
      </div>
        <ComputersCanvas/>
